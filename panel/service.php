        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading"><?php echo htmlspecialchars(panelT('services_done_list')); ?></header>
                            <table class="table table-striped border-top" id="sample_1">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hidden-phone"><?php echo htmlspecialchars(panelT('col_service_price_short')); ?></th>
                                        <th class="hidden-phone"><?php echo htmlspecialchars(panelT('col_service_type')); ?></th>
                                    </tr>
                                </thead>
                                <tbody> <?php
                                foreach($listinvoice as $list){
                                    $list['time'] = jdate('Y/m/d |  H:i:s',$list['time']);
                                    $list['type'] = panelServiceTypeLabel($list['type']);
