...
try {
    ...
    if (!$tableExists) {
        $stmt = $pdo->prepare("CREATE TABLE $tableName (
            ...
            language VARCHAR(10) NULL DEFAULT 'fa'
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci");
        $stmt->execute();
    } else {
        addFieldToTable($tableName, 'language', 'fa', "VARCHAR(10)");
